...
function convertRGB(hsl)
{
    ...
    if('h' in hsl && 's' in hsl && 'l' in hsl)
    {
        ...
        rgb.r = (rgb.r + offset)*255;
        rgb.g = (rgb.g + offset)*255;
        rgb.b = (rgb.b + offset)*255;
...
export function getComplement(newColor)
{
    let hsl = convertHSL(newColor);
    let complemColor = addDegree(hsl, 180);
    let hexComplemColor = convertRGB(complemColor);

    return hexComplemColor;
}

export function monoColor(newColor)
{
    let compBox = document.getElementsByClassName("rectangle monochrome");
    compBox[0].style.backgroundColor = newColor;
}


export function complemColor(newColor)
{
    let compBox = document.getElementsByClassName("rectangle complement");
    let hsl = convertHSL(newColor);
    let complemColor = addDegree(hsl, 180);
    let hexComplemColor = convertRGB(complemColor);
...
export function analogColor(newColor){
    let compBox = document.getElementsByClassName("rectangle analog");
...
export function splitColor(newColor){
    let compBox = document.getElementsByClassName("rectangle split-comp");
...
export function triadColor(newColor){
...
export function tetraColor(newColor){
